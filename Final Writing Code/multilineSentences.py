...
def generateSentence(sentence, hand_writer, fontLocation="../../FONTS/", debug=False):
    maxCharsPerLine = 35
    ...
    for line in lines:
        ...
        for letter in line:
            if letter == " ":
                ...
                if letter.isupper():
                    letter = letter + "_"
                sentenceImages.append(Helpers.getImageOfLetter(letter, fontLocation + hand_writer))
    ...
    if debug:
        totalCanvas.show()
    totalCanvas.save(sentence + " _" + hand_writer + ".jpg")
